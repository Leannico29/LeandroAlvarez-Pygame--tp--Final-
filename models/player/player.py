...
class Player:
    ...
    def __init__(self, coord_x, coord_y, frame_rate = 100, speed_walk = 6, speed_run = 12, gravity = 20, jump = 70):
        ...
        self.__falling_r = sf.get_surface_from_spritesheet('models\player\\fall\Fall.png',1,1)
        self.__falling_r = sf.get_surface_from_spritesheet('models\player\\fall\Fall.png',1,1, flip=True)
    ...
    def do_movement(self, delta_ms):
        ...
        if self.__player_move_time >= self.__frame_rate:
            ...
            if not self.__is_jumping and not self.__is_falling:
                # Solo actualiza la posición en el eje Y si no está saltando ni cayendo
